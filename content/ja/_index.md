...
多窗口 AI 并行工作成为日常，一个人指挥一群AI 分头干活的时代到了。
```
...
### 1. [Claude Code 复合工程插件登顶 GitHub 热榜](https://github.com/EveryInc/compound-engineering-plugin)
...
![图片](https://opengraph.githubassets.com/33c5641faa027b3cd06a53012a4ebbad3616c1b0429133ba5f7ccfdb5dd4a4fe/EveryInc/compound-engineering-plugin)

### 2. [Grok-1 开源：马斯克终于把底牌摊了](https://github.com/xai-org/grok-1)
...
### 3. [微软 Agent Lightning：训练 AI 智能体的"健身房"](https://github.com/microsoft/agent-lightning)
...
### 4. [PageIndex：不用向量也能做 RAG](https://github.com/VectifyAI/PageIndex)

向量数据库贵、慢、难调优，一直是 RAG 的老大难问题。这个项目另辟蹊径：用推理来替代向量检索。听起来反直觉，但实测在文档问答场景下效果不输传统方案，成本还更低。6000 Star 说明大家对"去向量化"这条路很感兴趣。

### 5. [多窗口 Claude Code 已成日常工作模式](https://x.com/op7418/status/2013896350648410441)
...
### 6. [tambo：给 React 加上"生成式 UI"能力](https://github.com/tambo-ai/tambo)

用户说一句话，界面自动生成——这不是科幻，这是 tambo 干的事。这个 SDK 让你能在 React 项目里直接用自然语言生成 UI 组件。3000Star 虽然不算爆款，但代表了前端开发的一个有趣方向：从"写界面"到"说界面"。

![图片](https://opengraph.githubassets.com/5360f4f175c69bceb93e10d7a35beec82b899bd6b948996bd3c64142ce47771c/tambo-ai/tambo)

### 7. [自动驾驶新思路：让大模型实时生成行为树](https://arxiv.org/abs/2601.12358)

传统自动驾驶的行为树是人工写死的，遇到没见过的情况就傻眼。这篇论文提出用LLM 实时生成行为树——车前面突然有障碍物？模型现场规划一条绕行路径。在CARLA 模拟器里测试，成功率相当不错。虽然离上路还远，但这个思路很有想象空间。

### 8. [HAVEN：终于有人认真做长视频理解了](https://arxiv.org/abs/2601.13719)
...
### 9. [微软数据科学入门课：10周从小白到入门](https://github.com/microsoft/Data-Science-For-Beginners)
...
- **[开源]** [X 推荐算法源代码](https://github.com/twitter/the-algorithm) - 7万+ Star 的老项目持续更新，想了解推荐系统的可以挖掘
- **[开源]** [try：给每种氛围准备的全新目录](https://github.com/tobi/try) - Shopify CEO搞的新玩意，3k Star，定位有点迷但很有趣
- **[研究]** [跨域目标检测：用无监督图像翻译搞