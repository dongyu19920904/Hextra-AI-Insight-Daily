...
```
Nvidia's data center revenue hit $75.2 billion in a single quarter, doubling year-over-year—AI compute demand hasn't peaked yet.
Manus founders are planning to raise $1 billion to buy back their company from Meta; Tencent open-sourced a translation-specific small model ready to use.
...
> 💡 **Tip**: Want to experience the latest AI models mentioned in this article (Claude 4.5, GPT, Gemini 3 Pro) right now? No account? Head to [**Aivora**](https://aivora.cn?utm_source=daily_news&utm_medium=mid_ad&utm_campaign=content) to grab one—one minute setup, hassle-free support.

## **Today's AI News**

### **👀 One-Liner**
Nvidia's data center revenue hit $75.2 billion in a single quarter—that's the number worth remembering today.
...
Data center segment: $75.2 billion in a single quarter. Last year at this time? Under $40 billion. Nearly doubled, and beat analyst expectations of $73.4 billion.

This isn't a single product line popping off—it's the entire AI infrastructure demand exploding collectively. Nvidia's Q1 total revenue: $81.6 billion, up 85% year-over-year. EPS: $1.87, also beating expectations. Q2 guidance also came in hot.

Stock rallied after hours, then reversed and dropped 1.6%. This "sell the news" pattern has happened in 4 out of Nvidia's last 5 earnings reports. But don't let the stock price fool you—the numbers themselves tell one story: AI compute demand hasn't hit its ceiling yet.

![Nvidia earnings chart](https://img.36krcdn.com/hsossms/20250521/v2_202e3e64c40f4d578a2934403557831c@1743780481_oswg35528oswg885oswg372_img_000?x-oss-process=image/format,jpg/interlace,1)

---

### 2. [Manus Founders Plan $1 Billion Fundraise to Buy Back Company from Meta](https://m.okjike.com/originalPosts/6a0ed759af7695b4cf0edd50)

The timeline on this story is wild. Meta announced a $2-3 billion acquisition of Manus in late 2025. In April, China's regulators demanded Meta cancel the deal. Now Manus founders—Xiao Hong, Ji Yichao, and Zhang Tao—are in talks to raise roughly $1 billion from external investors to buy the company back from Meta.

The new valuation reportedly needs to match Meta's original $2 billion acquisition price. Translation: the founders are spending $2 billion to redeem their own company.

Manus blew up as the "universal AI Agent" play, hailed as China's next DeepSeek-style AI company. If this buyback succeeds, it'll restart as a fully independent Chinese AI company. Bloomberg reported it; Manus hasn't commented yet.
...
Omni Flash generated a video of someone actually writing out the solution step-by-step on a blackboard. The visual output is clean, the logic is sound.
...
### 6. [Tencent Marvis Launches, Zhipu AutoClaw Releases, Photoshop 27.7 Major Update](https://www.aibase.com/zh/news/28221)

Three announcements bundled. Tencent rolled out Marvis, an OS-level AI assistant that can control phones and computers cross-device, with local privacy mode—sensitive operations require user confirmation before execution. That design detail matters; Tencent is thinking seriously about enterprise compliance.
...
But reality check: Tesla China's official channels haven't announced anything, and customer service still says "approval in progress, we'll push it as soon as cleared." Same line as before.

Current status: China's on the official list, but regulatory approval isn't done. For Chinese Tesla owners, it's a "getting close, but not yet" signal. Musk's attention is clearly elsewhere these days (politics, X), so FSD's China timeline probably depends more on regulators than Tesla.
...
The core trick: find an icon style reference you like, then tell AI "look at these app icons' style, generate a high-quality icon for 'xxx app' following the exact same visual style." Results are surprisingly good—the style consistency beats pure text descriptions by a mile.
...
Someone questioned a claim about Gemini models; the author dropped an official Google blog screenshot—from `blog.google/innovation-and-ai/sundar-pichai-io-2026/#gemini-models`.
...
Since 2026 started, Samsung and SK Hynix have been cashing in on the AI memory demand explosion. SK Hynix employees saw 25% monthly salary bumps, averaging 6.1 million yuan in performance bonuses. Result: Korean matchmaking companies now list "SK Hynix work uniform" as a dating market advantage. Engineers once called "engineering NPCs" are suddenly society's envy.
...
**[Research]** [SVFSearch: Game-Domain Short Video Frame Search Multimodal Benchmark](https://arxiv.org/abs/2605.17946) — Tests multimodal LLMs on paused-frame retrieval in short videos; visual ambiguity in gaming scenarios is harder than general cases. Fills a real evaluation gap.
...
The prompt was nearly 500 words long—down to "light blush on cheeks," "clothing slightly shifted from sitting," "don't overdo perfection."

The generated image actually looked pretty convincing.

The funniest part? The time spent writing the prompt probably exceeded the time it'd take to actually invite someone to hot pot. AI granted the wish, but the method was: turn your fantasy into a requirements document first.
...
### Translation-Specific Small Models Will Become Mainstream for Enterprise Localization Deployment
...
- **Timeline**: Q3 2026
- **Confidence**: 60%
- **Reasoning**: Today's news on [Manus founders' $1B buyback plan](https://m.okjike.com/originalPosts/6a0ed759af7695b4cf0edd50) shows negotiations are substantive, valuation anchored at $2B. China's regulators explicitly blocked foreign acquisition; founder team has strong independence intent; funding scale is basically viable. Post-buyback, Manus will likely restart as "China's autonomous AI Agent" and accelerate fundraising and product iteration.

### Nvidia Data Center Quarterly Revenue Breaks $100 Billion

- **Timeline**: Q4 2026
- **Confidence**: 55%
- **Reasoning**: Today's earnings show [Nvidia Q1 data center revenue at $75.2B](https://www.36kr.com/p/3818422732882820), nearly doubling year-over-year, with Q2 guidance also beating. At current growth curve, Q3-Q4 could hit the $100B threshold, but key variables are Blackwell Ultra shipment pace and whether China export restrictions tighten further.

### AI-Generated Teaching Videos Enter Mainstream Content Platforms

- **Timeline**: Q3 2026
- **Confidence**: 65%
- **Reasoning**: Today's demo of [Google Omni Flash generating blackboard solution videos](https://x.com/Gorden_Sun/status/2057286025488297996) shows AI can directly generate clear teaching videos—and this is just the Flash (lite) version. Pro version will push quality higher; platforms like Bilibili and YouTube will see an AI teaching content wave; traditional live-action course recording's cost advantage compresses fast.
