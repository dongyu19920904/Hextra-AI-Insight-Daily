...
I need you to translate and edit the Chinese text provided in the context above following the specific instructions given. Please apply the "zero-tolerance rule" first, then restructure content with topic-first approach, and finally apply style guidelines.
...
Welcome to **ai.hubtoday** (hereinafter referred to as "**the Site**" or "**we**"). Please read the following terms of service carefully before using our services. Your access to or use of the Site indicates your agreement to and acceptance of these terms.
...
- The Site reserves the right to **suspend or terminate** user accounts in violation of these terms.
